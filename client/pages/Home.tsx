...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-8 sm:py-16 lg:py-20 bg-gradient-to-b from-steel-50 to-white">
      ...
      {/* Categories Section */}
      <section className="py-8 sm:py-20 bg-gradient-to-b from-white to-steel-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-12">
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary mb-3 sm:mb-4">
              Categorías de Productos
            </h2>
            <p className="text-sm sm:text-lg text-steel-600 max-w-3xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-accent to-orange-600 text-white py-10 sm:py-24 md:py-32 relative overflow-hidden">
      ...
      {/* Navigation Section */}
      <section className="py-8 sm:py-20 bg-gradient-to-b from-primary to-steel-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-12">
