...
const WA_URL = `https://wa.me/524775990905?text=${encodeURIComponent("Hola, me gustaría recibir información sobre sus productos industriales.")}`;
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 mt-2 px-4 py-2.5 rounded-xl bg-[#25D366]/15 border border-[#25D366]/30 hover:bg-[#25D366]/25 hover:border-[#25D366]/60 transition-all duration-300 group w-fit"
              >
                <div className="w-5 h-5 flex-shrink-0">
                  <svg
                    viewBox="0 0 24 24"
                    className="w-full h-full fill-[#25D366] group-hover:scale-110 transition-transform"
                  >
